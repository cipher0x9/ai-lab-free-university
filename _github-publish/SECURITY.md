...
If you find a security issue in this learning pack, open a private security advisory on GitHub (when the public repo exists) or contact the maintainer via the GitHub profile [@cipher0x9](https://github.com/cipher0x9).
